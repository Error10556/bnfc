...
rules langname needBnfcTarget = linesToText
  ...
  , "Absyn.o: Absyn.cpp Absyn.hpp " ++ langname ++ ".loc.hpp"
  , "\t$(CXX_COMPILE)"
  , ""
  , langname ++ ".tab.o: " ++ langname ++ ".tab.cpp Parser.hpp \\"
  , "\tAbsyn.hpp " ++ langname ++ ".loc.hpp PatternMatching.hpp"
  ...
  , "\tAbsyn.hpp " ++ langname ++ ".loc.hpp PrinterCommon.hpp"
  , "\t$(CXX_COMPILE)"
  , ""
  ...
  , "\tAbsyn.hpp PrinterCommon.hpp " ++ langname ++ ".loc.hpp"
  , "\t$(CXX_COMPILE)"
  , ""
  ...
  , "\t$(AR_COMPILE)"
  , ""
  , "Test.o: Test.cpp Absyn.hpp Parser.hpp " ++ langname ++ ".loc.hpp \\"
